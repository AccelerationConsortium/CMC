...
################################################################################################################################################
    ...
    def CMC_surfactant_mix(exp, solvent_mix_loc):
        ...
        pipette.well_bottom_clearance.aspirate = 10
    ...
    def process_a_row(row, vols, source, destination, touch_tip):
        ...
        for i, vol in enumerate(vols):
            ...
            for _ in range(transfer_repeat):
                new_pipette.transfer(vol/transfer_repeat, source, destination[row + str(i+1)], new_tip='never', air_gap=vol/10, blow_out=True, blow_out_location='destination well')
